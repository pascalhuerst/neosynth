...
impl Engine {
    pub fn new(input_device: String, output_device: String, sample_rate: u32) -> Self {
        Self {
            ...
            num_output_channels: DEFAULT_OUTPUT_CHANNELS,
        }
    }
    ...
    pub fn set_output_channels(&mut self, n: u32) {
        self.num_output_channels = n;
    }
    ...
    pub fn run(
        ...
        let num_output_channels = self.num_output_channels as usize;
